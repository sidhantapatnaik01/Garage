...
export const SERVICES = [
  { icon: '⬡', title: 'Dent Repair',          desc: 'Precision dent removal restoring panels to factory finish without repainting',      gradient: 'from-[#e63946] to-[#ff6b6b]' },
  { icon: '◇', title: 'Scratch Removal',       desc: 'Deep and surface scratch repair with exact OEM colour matching',                    gradient: 'from-[#3b82f6] to-[#60a5fa]' },
  { icon: '◎', title: 'Bumper Repair',         desc: 'Scuffs, cracks, and full bumper repainting and structural restoration',            gradient: 'from-[#f59e0b] to-[#fbbf24]' },
  { icon: '▣', title: 'Panel Paint',           desc: 'Professional panel painting with OEM-grade colour match technology',               gradient: 'from-[#10b981] to-[#34d399]' },
  { icon: '◉', title: 'Body Polishing',        desc: 'Machine polishing for showroom-quality shine and UV protection',                   gradient: 'from-[#8b5cf6] to-[#a78bfa]' },
  { icon: '⚡', title: 'Accident Repair',       desc: 'Minor collision damage restored quickly with insurance documentation',             gradient: 'from-[#ef4444] to-[#f87171]' },
  { icon: '◈', title: 'Exterior Restoration',  desc: 'Full body makeover for aging, faded or weather-worn vehicles',                    gradient: 'from-[#06b6d4] to-[#22d3ee]' },
  { icon: '✦', title: 'Car Detailing',         desc: 'Interior and exterior deep clean with ceramic coating option',                     gradient: 'from-[#ec4899] to-[#f472b6]' },
]
